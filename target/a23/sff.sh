...
# SEC Floating Feature configuration file for Galaxy A23 4G (a23)
...
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_a23_sm6225
...
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy A23 4G
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMA235FN
